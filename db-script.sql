...
INSERT INTO batch (number, programme_id)
VALUES ('100', 'P001'),
       ('50', 'P002'),
       ('120', 'P003'),
       ('80', 'P004'),
...
INSERT INTO module (id, name, credits)
VALUES ('M001', 'Introduction to Programming', 3),
...
INSERT INTO exam (exam_code, passing_score, module_id)
VALUES ('E001', 75, 'M001'),
       ('E002', 78, 'M005'),
       ('E003', 45, 'M005'),
       ('E004', 96, 'M007'),
...
(
    ...
    CONSTRAINT fk_batch_number FOREIGN KEY (batch_number) REFERENCES enrollment (batch_id),
    CONSTRAINT fk_exam_code FOREIGN KEY (exam_code) REFERENCES exam (exam_code)
);

INSERT INTO programe_module (program_id, module_id)
VALUES ('P001', 'M001'),
       ('P001', 'M002'),
       ('P001', 'M003'),
       ('P001', 'M004'),
...
INSERT INTO student_batch (student_id, batch_id, reg_date)
VALUES ('S001', 'B001', '2023-01-15'),
...
INSERT INTO student_exam (student_id, exam_code, batch_number, mark)
VALUES ('S001', 'E001', '100', 55),
       ('S002', 'E002', '50', 64),
       ('S003', 'E005', '120', 85),
       ('S004', 'E004', '80', 84),
       ('S005', 'E008', '300', 94),
